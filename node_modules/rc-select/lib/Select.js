...
var _useFilterOptions = _interopRequireDefault(
...
var _warningPropsUtil = _interopRequireWildcard(
...
var Select = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  // =========================== Option ===========================
  var parsedOptions = (0, _useOptions.default)(
    options,
    children,
    mergedFieldNames,
    optionFilterProp,
      ...
      if (mode === "combobox") {
        ...
        var strValue =
          ...
          _mergedValues$ === void 0
            ...
            : _mergedValues$.value;
        setSearchValue(
          (0, _commonUtil.hasValue)(strValue) ? String(strValue) : "",
        );
      }
    },
    [mergedValues],
  ...
  var createTagOption = (0, _useRefFunc.default)(function (val, label) {
    ...
    return (0, _defineProperty2.default)(
      (0, _defineProperty2.default)({}, mergedFieldNames.value, val),
  ...
  var filledTagOptions = React.useMemo(
    function () {
      ...
      (0, _toConsumableArray2.default)(mergedValues)
        .sort(function (a, b) {
  ...
  var filteredOptions = (0, _useFilterOptions.default)(
    filledTagOptions,
    mergedFieldNames,
    mergedSearchValue,
    mergedFilterOption,
  ...
  var filledSearchOptions = React.useMemo(
    function () {
      ...
      return [createTagOption(mergedSearchValue)].concat(
        (0, _toConsumableArray2.default)(filteredOptions),
      );
    },
    [
      createTagOption,
  ...
  var sorter = function sorter(inputOptions) {
    var sortedOptions = (0, _toConsumableArray2.default)(inputOptions).sort(
      function (a, b) {
  ...
  var onInternalSelect = (0, _useRefFunc.default)(function (val, info) {
    ...
    if (mergedSelect) {
      cloneValues = multiple
        ? [].concat((0, _toConsumableArray2.default)(mergedValues), [val])
        : [val];
    } else {
    ...
    if (info.source === "submit") {
      ...
      if (formatted) {
        var newRawValues = Array.from(
          new Set(
            [].concat((0, _toConsumableArray2.default)(rawValues), [formatted]),
          ),
        );
  ...
  var onInternalSearchSplit = function onInternalSearchSplit(words) {
    ...
    var newRawValues = Array.from(
      new Set(
        [].concat(
          (0, _toConsumableArray2.default)(rawValues),
          (0, _toConsumableArray2.default)(patchValues),
        ),
      ),
    );
    triggerChange(newRawValues);
  ...
  var selectContext = React.useMemo(
    function () {
      ...
      return (0, _objectSpread2.default)(
        (0, _objectSpread2.default)({}, parsedOptions),
        {},
        {
  ...
  return /*#__PURE__*/ React.createElement(
    _SelectContext.default.Provider,
    {
      value: selectContext,
    },
