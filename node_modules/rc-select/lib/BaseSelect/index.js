...
var _useMergedState3 = _interopRequireDefault(
...
var _useSelectTriggerControl = _interopRequireDefault(
  require("../hooks/useSelectTriggerControl"),
);
...
var BaseSelect = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  var customizeRawInputRef = (0, _ref2.useComposeRef)(
    selectorDomRef,
  ...
  var onInternalSearch = function onInternalSearch(
    ...
    if (
      multiple &&
      (0, _valueUtil.isValidCount)(maxCount) &&
    ...
    onActiveValueChange === null ||
      ...
      onActiveValueChange(null);
    var separatedList = (0, _valueUtil.getSeparatedContent)(
      searchText,
      tokenSeparators,
      (0, _valueUtil.isValidCount)(maxCount)
  ...
  var _useAllowClear = (0, _useAllowClear2.useAllowClear)(
      prefixCls,
      onClearMouseDown,
      displayValues,
      allowClear,
  ...
  return /*#__PURE__*/ React.createElement(
    _useBaseProps.BaseSelectContext.Provider,
    {
