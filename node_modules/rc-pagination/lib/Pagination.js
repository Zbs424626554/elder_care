...
var Pagination = function Pagination(props) {
  ...
  function handleKeyDown(event) {
    if (
      event.keyCode === _KeyCode.default.UP ||
      event.keyCode === _KeyCode.default.DOWN
    ) {
  ...
  function runIfEnter(event, callback) {
    if (
      event.key === "Enter" ||
      event.charCode === _KeyCode.default.ENTER ||
      event.keyCode === _KeyCode.default.ENTER
    ) {
      for (
  ...
  function renderPrev(prevPage) {
    ...
    return /*#__PURE__*/ _react.default.isValidElement(prevButton)
      ? /*#__PURE__*/ _react.default.cloneElement(prevButton, {
          disabled: !hasPrev,
        })
      : prevButton;
  }
  function renderNext(nextPage) {
    ...
    return /*#__PURE__*/ _react.default.isValidElement(nextButton)
      ? /*#__PURE__*/ _react.default.cloneElement(nextButton, {
          disabled: !hasNext,
        })
      : nextButton;
  }
  ...
  // FIXME: ts type
  var isReadOnly =
    (0, _typeof2.default)(simple) === "object" ? simple.readOnly : !simple;
  ...
  if (simple) {
    ...
    if (goButton) {
      if (typeof goButton === "boolean") {
        gotoButton = /*#__PURE__*/ _react.default.createElement(
          "button",
          {
            type: "button",
            onClick: handleGoTO,
    ...
    simplePager = /*#__PURE__*/ _react.default.createElement(
      "li",
      {
  ...
  if (allPages <= 3 + pageBufferSize * 2) {
    if (!allPages) {
      pagerList.push(
        /*#__PURE__*/ _react.default.createElement(
          _Pager.default,
          (0, _extends2.default)({}, pagerProps, {
            key: "noPager",
            page: 1,
    ...
    if (allPages - current >= pageBufferSize * 2 && current !== allPages - 2) {
      ...
      pagerList[pagerList.length - 1] =
        /*#__PURE__*/ _react.default.cloneElement(lastOne, {
          className: (0, _classnames.default)(
  ...
  if (prev) {
    ...
    prev = /*#__PURE__*/ _react.default.createElement(
      "li",
      {
  ...
  if (next) {
    ...
    next = /*#__PURE__*/ _react.default.createElement(
      "li",
      {
