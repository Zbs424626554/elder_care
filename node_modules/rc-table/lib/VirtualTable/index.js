...
function VirtualTable(props, ref) {
  var data = props.data,
    ...
    prefixCls =
      _props$prefixCls === void 0 ? _Table.DEFAULT_PREFIX : _props$prefixCls,
  ...
  if (typeof scrollY !== "number") {
    ...
    if (process.env.NODE_ENV !== "production") {
      (0, _rcUtil.warning)(
        false,
        "`scroll.y` in virtual table must be number.",
      );
    }
  }
  ...
  return /*#__PURE__*/ React.createElement(
    _context.StaticContext.Provider,
    {
      value: context,
    },
    /*#__PURE__*/ React.createElement(
      ...
      (0, _extends2.default)({}, props, {
        className: (0, _classnames.default)(
          className,
          "".concat(prefixCls, "-virtual"),
        ),
        scroll: (0, _objectSpread2.default)(
          (0, _objectSpread2.default)({}, scroll),
          {},
          {
            x: scrollX,
          },
