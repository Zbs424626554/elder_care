...
function useExpand(props, mergedData, getRowKey) {
  ...
  var expandableType = React.useMemo(
    function () {
      ...
      if (
        (props.expandable &&
          props.internalHooks === _constant.INTERNAL_HOOKS &&
  ...
  var _React$useState = React.useState(function () {
      ...
      if (defaultExpandAllRows) {
        return (0, _expandUtil.findAllChildrenKeys)(
          mergedData,
          getRowKey,
    ...
    function (record) {
      ...
      if (hasKey) {
        ...
        newExpandedKeys = [].concat(
          (0, _toConsumableArray2.default)(mergedExpandedKeys),
          [key],
        );
      }
  ...
  if (
    ...
    (0, _warning.default)(
      false,
      "`expandedRowRender` should not use with nested Table",
    );
  }
  return [
    expandableConfig,
