...
function filterHiddenColumns(columns) {
  return columns
    .filter(function (column) {
      return (
        column && (0, _typeof2.default)(column) === "object" && !column.hidden
      );
    })
    .map(function (column) {
      ...
      if (subColumns && subColumns.length > 0) {
        return (0, _objectSpread2.default)(
          (0, _objectSpread2.default)({}, column),
          {},
          {
...
function useColumns(_ref2, transformColumns) {
  var prefixCls = _ref2.prefixCls,
    ...
    expandedRowOffset =
      _ref2$expandedRowOffs === void 0 ? 0 : _ref2$expandedRowOffs,
    ...
    function () {
      if (expandable) {
        ...
        if (!cloneColumns.includes(_constant.EXPAND_COLUMN)) {
          ...
          if (
            expandColIndex >= 0 &&
            (expandColIndex || fixed === "left" || !fixed)
          ) {
        ...
        cloneColumns = cloneColumns.filter(function (column, index) {
          return (
            column !== _constant.EXPAND_COLUMN || index === expandColumnIndex
          );
        });
        ...
        var expandColumn = (0, _defineProperty2.default)(
      ...
      if (
        process.env.NODE_ENV !== "production" &&
        baseColumns.includes(_constant.EXPAND_COLUMN)
      ) {
        (0, _warning.default)(
          false,
  ...
  // ========================= FillWidth ========================
  var _useWidthColumns = (0, _useWidthColumns3.default)(
      flattenColumns,
      scrollWidth,
      clientWidth,
    ),
