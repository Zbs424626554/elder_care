...
var _useStickyOffsets = _interopRequireDefault(
  require("./hooks/useStickyOffsets"),
);
...
var _useLayoutEffect = _interopRequireDefault(
  require("rc-util/lib/hooks/useLayoutEffect"),
);
...
function Table(tableProps, ref) {
  ...
  var _useColumns = (0, _useColumns3.default)(
  ...
  var stickyOffsets = (0, _useStickyOffsets.default)(
    colWidths,
    flattenColumns,
    direction,
  );
  ...
  var horizonScroll =
    (scroll && (0, _valueUtil.validateValue)(mergedScrollX)) ||
  ...
  var fixFooter =
    ...
    summaryNode.type === _Summary.default &&
  ...
  (0, _useLayoutEffect.default)(function () {
    if (!tailor || !useInternalHooks) {
      if (scrollBodyRef.current instanceof Element) {
        setScrollbarSize(
          (0, _getScrollBarSize.getTargetScrollBarSize)(scrollBodyRef.current)
            .width,
        );
      } else {
        setScrollbarSize(
          (0, _getScrollBarSize.getTargetScrollBarSize)(
            scrollBodyContainerRef.current,
          ).width,
        );
      }
    }
  ...
  if (fixHeader || isSticky) {
      ...
      bodyContent = /*#__PURE__*/ React.createElement(
        "div",
        {
          style: (0, _objectSpread2.default)(
            (0, _objectSpread2.default)({}, scrollXStyle),
            scrollYStyle,
          ),
        ...
        /*#__PURE__*/ React.createElement(
          ...
          (0, _extends2.default)(
            {
              style: (0, _objectSpread2.default)(
                (0, _objectSpread2.default)({}, scrollTableStyle),
                {},
                {
    ...
    var fixedHolderProps = (0, _objectSpread2.default)(
      (0, _objectSpread2.default)(
        (0, _objectSpread2.default)(
          {
    ...
    groupTableNode = /*#__PURE__*/ React.createElement(
      ...
      showHeader !== false &&
        /*#__PURE__*/ React.createElement(
          _FixedHolder.default,
          (0, _extends2.default)({}, fixedHolderProps, {
      ...
      isSticky &&
        ...
        /*#__PURE__*/ React.createElement(_stickyScrollBar.default, {
          ref: stickyRef,
    ...
    groupTableNode = /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        showHeader !== false &&
          /*#__PURE__*/ React.createElement(
            _Header.default,
            (0, _extends2.default)({}, headerProps, columnContext),
          ),
        bodyTable,
        summaryNode &&
          /*#__PURE__*/ React.createElement(
  ...
  var fixedInfoList = (0, _useFixedInfo.default)(
    flattenColumns,
    stickyOffsets,
    direction,
  );
