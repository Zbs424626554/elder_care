...
var _getScrollBarSize = _interopRequireDefault(
  require("rc-util/lib/getScrollBarSize"),
);
...
var StickyScrollBar = function StickyScrollBar(_ref, ref) {
  ...
  var onMouseMove = function onMouseMove(event) {
    ...
    var shouldScroll =
      !isRTL || Math.abs(left) + Math.abs(scrollBarWidth) < bodyWidth;
    if (shouldScroll) {
      onScroll({
  ...
  var checkScrollBarVisible = function checkScrollBarVisible() {
    ...
    rafRef.current = (0, _raf.default)(function () {
      ...
      var tableOffsetTop = (0, _offsetUtil.getOffset)(
      ...
      var currentClientOffset =
        container === window
          ...
          : (0, _offsetUtil.getOffset)(container).top + container.clientHeight;
      if (
        tableBottomOffset - (0, _getScrollBarSize.default)() <=
          currentClientOffset ||
  ...
  React.useEffect(
    function () {
      var onMouseUpListener = (0, _addEventListener.default)(
        document.body,
        "mouseup",
        onMouseUp,
        false,
      );
      var onMouseMoveListener = (0, _addEventListener.default)(
        document.body,
        "mousemove",
        onMouseMove,
        false,
...
var _default = (exports.default =
  /*#__PURE__*/ React.forwardRef(StickyScrollBar));
