...
var FixedHolder = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  var _useContext = (0, _context.useContext)(_TableContext.default, [
      "prefixCls",
      "scrollbarSize",
      "isSticky",
      "getComponent",
  ...
  var columnsWithScrollbar = (0, _react.useMemo)(
    function () {
  ...
  var flattenColumnsWithScrollbar = (0, _react.useMemo)(
    function () {
      return combinationScrollBarSize
        ? [].concat((0, _toConsumableArray2.default)(flattenColumns), [
            ScrollBarColumn,
          ])
        : flattenColumns;
    },
  ...
  var headerStickyOffsets = (0, _react.useMemo)(
    function () {
      var right = stickyOffsets.right,
        left = stickyOffsets.left;
      return (0, _objectSpread2.default)(
        (0, _objectSpread2.default)({}, stickyOffsets),
        {},
        {
          left:
            direction === "rtl"
  ...
  return /*#__PURE__*/ React.createElement(
    "div",
    {
      ...
      className: (0, _classnames.default)(
        className,
        (0, _defineProperty2.default)({}, stickyClassName, !!stickyClassName),
      ),
    },
      ...
      (!noData || !maxContentScroll || allFlattenColumnsWithWidth) &&
        /*#__PURE__*/ React.createElement(_ColGroup.default, {
          colWidths: mergedColumnWidth
            ? [].concat((0, _toConsumableArray2.default)(mergedColumnWidth), [
