...
var _useRenderTimes = _interopRequireDefault(
  require("../hooks/useRenderTimes"),
);
...
function getCellProps(rowInfo, column, colIndex, indent, index) {
  ...
  var additionalCellProps =
    ((_column$onCell = column.onCell) === null || _column$onCell === void 0
      ? void 0
      : _column$onCell.call(column, record, index)) || {};
...
function BodyRow(props) {
  ...
  var expandedClsName = (0, _expandUtil.computedExpandedClassName)(
  ...
  var baseRowNode = /*#__PURE__*/ React.createElement(
    ...
    (0, _extends2.default)({}, rowProps, {
      ...
      className: (0, _classnames.default)(
        ...
        (0, _defineProperty2.default)({}, expandedClsName, indent >= 1),
      ),
    ...
    flattenColumns.map(function (column, colIndex) {
      ...
      var _getCellProps = getCellProps(
          ...
          index,
          rowKeys,
          expandedRowInfo === null || expandedRowInfo === void 0
            ? void 0
...
var _default = (exports.default = (0, _TableContext.responseImmutable)(
  BodyRow,
));
