...
var _useFlattenRecords = _interopRequireDefault(
  require("../hooks/useFlattenRecords"),
);
...
function Body(props) {
  ...
  var _useContext = (0, _context.useContext)(_TableContext.default, [
    ...
    expandedRowOffset =
      _useContext$expandedR === void 0 ? 0 : _useContext$expandedR,
    colWidths = _useContext.colWidths;
  var flattenData = (0, _useFlattenRecords.default)(
    data,
    childrenColumnName,
    expandedKeys,
    getRowKey,
  );
  var rowKeys = React.useMemo(
    function () {
  ...
  var expandedRowInfo = React.useMemo(
    function () {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(
      ...
      measureColumnWidth &&
        /*#__PURE__*/ React.createElement(_MeasureRow.default, {
          prefixCls: prefixCls,
