...
var INTERNAL_COL_DEFINE = (exports.INTERNAL_COL_DEFINE =
  "RC_TABLE_INTERNAL_COL_DEFINE");
function getExpandableProps(props) {
  var expandable = props.expandable,
    legacyExpandableConfig = (0, _objectWithoutProperties2.default)(
      props,
      _excluded,
    );
  var config;
  if ("expandable" in props) {
    config = (0, _objectSpread2.default)(
      (0, _objectSpread2.default)({}, legacyExpandableConfig),
      expandable,
    );
  } else {
    if (
