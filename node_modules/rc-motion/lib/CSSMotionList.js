            ...
            return /*#__PURE__*/ React.createElement(
              ...
              keyEntities.map(function (_ref2, index) {
                var status = _ref2.status,
                  eventProps = (0, _objectWithoutProperties2.default)(
                    _ref2,
                    _excluded2,
                  );
                var visible =
                  status === _diff.STATUS_ADD || status === _diff.STATUS_KEEP;
                return /*#__PURE__*/ React.createElement(
                  CSSMotion,
                  (0, _extends2.default)({}, motionProps, {
                    key: eventProps.key,
                    visible: visible,
      ...
      [
        {
          ...
          value: function getDerivedStateFromProps(_ref3, _ref4) {
            ...
            var mixedKeyEntities = (0, _diff.diffKeys)(
              keyEntities,
              parsedKeyObjects,
            );
            return {
              keyEntities: mixedKeyEntities.filter(function (entity) {
                ...
                if (
                  prevEntity &&
                  prevEntity.status === _diff.STATUS_REMOVED &&
                  entity.status === _diff.STATUS_REMOVE
                ) {
                  return false;
                }
                return true;
