...
var _findDOMNode = _interopRequireDefault(
  require("rc-util/lib/Dom/findDOMNode"),
);
...
function genCSSMotion(config) {
  ...
  var CSSMotion = /*#__PURE__*/ React.forwardRef(function (props, ref) {
    ...
    function getDomElement() {
      try {
        ...
        return nodeRef.current instanceof HTMLElement
          ? nodeRef.current
          : (0, _findDOMNode.default)(wrapperNodeRef.current);
      } catch (e) {
    ...
    var mergedProps = (0, _objectSpread2.default)(
      (0, _objectSpread2.default)({}, eventProps),
      {},
      {
        visible: visible,
      },
    ...
    if (!children) {
      ...
      if (mergedVisible) {
        motionChildren = children(
          (0, _objectSpread2.default)({}, mergedProps),
          setNodeRef,
        );
      ...
      var motionCls = (0, _motion.getTransitionName)(
        motionName,
        ...
        (0, _objectSpread2.default)(
          ...
          {},
          {
            className: (0, _classnames.default)(
              (0, _motion.getTransitionName)(motionName, status),
    ...
    if (
      ...
      (0, _ref.supportRef)(motionChildren)
    ) {
