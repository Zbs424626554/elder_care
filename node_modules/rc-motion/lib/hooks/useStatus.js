...
var _useSyncState3 = _interopRequireDefault(
  require("rc-util/lib/hooks/useSyncState"),
);
var _react = _interopRequireWildcard(require("react"));
var React = _react;
var _interface = require("../interface");
var _useDomMotionEvents3 = _interopRequireDefault(
  require("./useDomMotionEvents"),
);
var _useIsomorphicLayoutEffect = _interopRequireDefault(
...
function useStatus(supportMotion, visible, getElement, _ref) {
  ...
  var _useDomMotionEvents = (0, _useDomMotionEvents3.default)(
      onInternalMotionEnd,
    ),
  ...
  var _useStepQueue = (0, _useStepQueue3.default)(
      currentStatus,
      !supportMotion,
      function (newStep) {
        ...
        if (
          step === _interface.STEP_ACTIVE &&
          currentStatus !== _interface.STATUS_NONE
        ) {
  ...
  (0, _useIsomorphicLayoutEffect.default)(
    function () {
      ...
      if (
        nextStatus &&
        (supportMotion || nextEventHandlers[_interface.STEP_PREPARE])
      ) {
  ...
  if (
    eventHandlers[_interface.STEP_PREPARE] &&
    step === _interface.STEP_START
  ) {
