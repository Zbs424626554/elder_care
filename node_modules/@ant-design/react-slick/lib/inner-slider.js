...
var _isNativeReflectConstruct2 = _interopRequireDefault(
  require("@babel/runtime/helpers/isNativeReflectConstruct"),
);
  ...
  function InnerSlider(props) {
      ...
      if (_this.props.lazyLoad) {
        var slidesToLoad = (0, _innerSliderUtils.getOnDemandLazySlides)(
          (0, _objectSpread2["default"])(
            (0, _objectSpread2["default"])({}, _this.props),
            _this.state,
          ),
        );
    ...
    (0, _defineProperty2["default"])(
      ...
      function (setTrackStyle) {
        ...
        _this.debouncedResize = (0, _throttleDebounce.debounce)(
          50,
          function () {
      ...
      _this.setState(state, function () {
        ...
        _this.animationEndCallback = setTimeout(function () {
          var animating = nextState.animating,
            firstBatch = (0, _objectWithoutProperties2["default"])(
              nextState,
              _excluded,
            );
    ...
    (0, _defineProperty2["default"])(_this, "render", function () {
      ...
      trackProps = (0, _objectSpread2["default"])(
        (0, _objectSpread2["default"])({}, trackProps),
        {},
        {
      ...
      if (
        ...
        dotProps = (0, _objectSpread2["default"])(
          (0, _objectSpread2["default"])({}, dotProps),
          {},
          {
      ...
      var listStyle = (0, _objectSpread2["default"])(
        (0, _objectSpread2["default"])({}, verticalHeightStyle),
        centerPaddingStyle,
      );
    ...
    _this.state = (0, _objectSpread2["default"])(
      (0, _objectSpread2["default"])({}, _initialState["default"]),
      {},
      {
  ...
  return (0, _createClass2["default"])(InnerSlider, [
    {
      ...
      value: function didPropsChange(prevProps) {
        ...
        for (
          ...
          if (
            (0, _typeof2["default"])(prevProps[key]) === "object" ||
