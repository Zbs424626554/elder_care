...
var _useDirectionStyle = _interopRequireDefault(
  require("../hooks/useDirectionStyle"),
);
...
var InternalSubMenu = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  var _useActive = (0, _useActive2.default)(
    ...
    activeProps = (0, _objectWithoutProperties2.default)(
      _useActive,
      _excluded2,
    );
  ...
  var expandIconNode = React.useMemo(
    function () {
...
var SubMenu = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  return /*#__PURE__*/ React.createElement(
    _PathContext.PathTrackerContext.Provider,
    {
