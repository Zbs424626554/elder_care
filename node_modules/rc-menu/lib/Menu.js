...
var _useMergedState7 = _interopRequireDefault(
...
var _PrivateContext = _interopRequireDefault(
  require("./context/PrivateContext"),
);
...
var _useMemoCallback = _interopRequireDefault(
  require("./hooks/useMemoCallback"),
);
...
var Menu = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  var _React$useMemo = React.useMemo(
      function () {
        return [
          ...
          (0, _nodeUtil.parseItems)(children, items, EMPTY_LIST, {}, prefixCls),
        ];
      },
  ...
  // ======================== Active ========================
  var _useMergedState3 = (0, _useMergedState7.default)(
      activeKey ||
        (defaultActiveFirst &&
  ...
  (0, _react.useImperativeHandle)(ref, function () {
    return {
      ...
      focus: function focus(options) {
        var _childList$find;
        var keys = getKeys();
        var _refreshElements = (0, _useAccessibility.refreshElements)(
            keys,
            uuid,
          ),
        ...
        var focusableElements = (0, _useAccessibility.getFocusableElements)(
  ...
  // ======================== Select ========================
  // >>>>> Select keys
  var _useMergedState5 = (0, _useMergedState7.default)(
      defaultSelectedKeys || [],
      {
        value: selectedKeys,
  ...
  var triggerSelection = function triggerSelection(info) {
    if (selectable) {
      ...
      if (multiple) {
        if (exist) {
          ...
          newSelectKeys = [].concat(
            (0, _toConsumableArray2.default)(mergedSelectKeys),
            [targetKey],
          );
        }
      } else {
      ...
      // Trigger event
      var selectInfo = (0, _objectSpread2.default)(
        (0, _objectSpread2.default)({}, info),
        {},
        {
  ...
  var onInternalOpenChange = (0, _useMemoCallback.default)(
    function (key, open) {
  ...
  var onInternalKeyDown = (0, _useAccessibility.useAccessibility)(
    internalMode,
    mergedActiveKey,
    isRtl,
    uuid,
    ...
    (0, _extends2.default)(
      {
        ...
        maxCount:
          internalMode !== "horizontal" || disabledOverflow
            ? _rcOverflow.default.INVALIDATE
            : _rcOverflow.default.RESPONSIVE,
        ssr: "full",
        "data-menu-list": true,
  ...
  // >>>>> Render
  return /*#__PURE__*/ React.createElement(
    _PrivateContext.default.Provider,
    {
      value: privateContext,
    },
    /*#__PURE__*/ React.createElement(
      _IdContext.IdContext.Provider,
      {
        value: uuid,
      },
      /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(
          _PathContext.PathUserContext.Provider,
          {
        ...
        /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            _PathContext.PathRegisterContext.Provider,
            {
