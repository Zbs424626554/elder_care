...
var InternalMentions = /*#__PURE__*/ (0, _react.forwardRef)(
  function (props, ref) {
    var prefixCls = props.prefixCls,
      ...
      validateSearch =
        _props$validateSearch === void 0
          ? _util.validateSearch
          : _props$validateSearch,
      _props$filterOption = props.filterOption,
      filterOption =
        _props$filterOption === void 0
          ? _util.filterOption
          : _props$filterOption,
    ...
    var mergedPrefix = (0, _react.useMemo)(
      function () {
    ...
    var getTextArea = function getTextArea() {
      ...
      return (_textareaRef$current = textareaRef.current) === null ||
        _textareaRef$current === void 0 ||
        (_textareaRef$current = _textareaRef$current.resizableTextArea) ===
          null ||
        _textareaRef$current === void 0
        ? void 0
    ...
    _react.default.useImperativeHandle(ref, function () {
      ...
      return {
        focus: function focus() {
          ...
          return (_textareaRef$current2 = textareaRef.current) === null ||
        ...
        blur: function blur() {
          ...
          return (_textareaRef$current3 = textareaRef.current) === null ||
            _textareaRef$current3 === void 0
            ? void 0
            : _textareaRef$current3.blur();
        },
        textarea:
          (_textareaRef$current4 = textareaRef.current) === null ||
          _textareaRef$current4 === void 0 ||
          (_textareaRef$current4 = _textareaRef$current4.resizableTextArea) ===
            null ||
          _textareaRef$current4 === void 0
            ? void 0
            : _textareaRef$current4.textArea,
    ...
    var _React$useMemo = _react.default.useMemo(
        function () {
          if (open) {
    ...
    // ============================== Option ==============================
    var getOptions = _react.default.useCallback(
        ...
        if (options && options.length > 0) {
          ...
          list = (0, _toArray.default)(children).map(function (_ref) {
            var optionProps = _ref.props,
              key = _ref.key;
            return (0, _objectSpread2.default)(
              (0, _objectSpread2.default)({}, optionProps),
              {},
              {
    ...
    var mergedOptions = _react.default.useMemo(
      function () {
    ...
    var selectOption = function selectOption(option) {
      ...
      var _replaceWithMeasure = (0, _util.replaceWithMeasure)(mergedValue, {
          ...
          selectionStart:
            (_getTextArea = getTextArea()) === null || _getTextArea === void 0
              ? void 0
              : _getTextArea.selectionStart,
          split: split,
        }),
    ...
    var onInternalKeyUp = function onInternalKeyUp(event) {
      ...
      if (measureIndex !== -1) {
        var nextMeasureText = selectionStartText.slice(
    ...
    return /*#__PURE__*/ _react.default.createElement(
      ...
      mergedMeasuring &&
        /*#__PURE__*/ _react.default.createElement(
          ...
          /*#__PURE__*/ _react.default.createElement(
            _MentionsContext.default.Provider,
            {
              value: {
...
var Mentions = /*#__PURE__*/ (0, _react.forwardRef)(function (_ref3, ref) {
  ...
  (0, _react.useImperativeHandle)(ref, function () {
    ...
    return (0, _objectSpread2.default)(
      (0, _objectSpread2.default)({}, mentionRef.current),
      {},
      {
        nativeElement:
          ...
          _holderRef$current === void 0
            ? void 0
            : _holderRef$current.nativeElement) ||
          ((_mentionRef$current = mentionRef.current) === null ||
          _mentionRef$current === void 0
            ? void 0
            : _mentionRef$current.nativeElement),
      },
    );
  });
  ...
  return /*#__PURE__*/ _react.default.createElement(
    ...
    /*#__PURE__*/ _react.default.createElement(
      ...
      (0, _extends2.default)(
        {
          className:
            classes === null || classes === void 0 ? void 0 : classes.mentions,
          prefixCls: prefixCls,
          ref: mentionRef,
