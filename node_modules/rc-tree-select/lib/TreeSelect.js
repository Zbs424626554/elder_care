...
var _useMergedState5 = _interopRequireDefault(
...
var _useCheckedKeys3 = _interopRequireDefault(
  require("./hooks/useCheckedKeys"),
);
var _useDataEntities2 = _interopRequireDefault(
  require("./hooks/useDataEntities"),
);
var _useFilterTreeData = _interopRequireDefault(
  require("./hooks/useFilterTreeData"),
);
...
var _warningPropsUtil = _interopRequireDefault(
  require("./utils/warningPropsUtil"),
);
var _excluded = [
  "id",
  "prefixCls",
...
var TreeSelect = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  var id = props.id,
    ...
    prefixCls =
      _props$prefixCls === void 0 ? "rc-tree-select" : _props$prefixCls,
    value = props.value,
    ...
    treeNodeFilterProp =
      _props$treeNodeFilter === void 0 ? "value" : _props$treeNodeFilter,
    ...
    listItemScrollOffset =
      _props$listItemScroll === void 0 ? 0 : _props$listItemScroll,
  ...
  var mergedShowCheckedStrategy = React.useMemo(
    function () {
      if (!treeCheckable) {
  ...
  var mergedTreeData = (0, _useTreeData.default)(
    treeData,
    children,
    treeDataSimpleMode,
  );
  var _useDataEntities = (0, _useDataEntities2.default)(
      mergedTreeData,
      mergedFieldNames,
    ),
  ...
  var splitRawValues = React.useCallback(
  ...
  // Filtered Tree
  var filteredTreeData = (0, _useFilterTreeData.default)(
    mergedTreeData,
    mergedSearchValue,
    {
  ...
  // =========================== Label ============================
  var getLabel = React.useCallback(
    function (item) {
      if (item) {
  ...
  // =========================== Values ===========================
  var rawMixedLabeledValues = React.useMemo(
    function () {
  ...
  var _useCheckedKeys = (0, _useCheckedKeys3.default)(
      rawLabeledValues,
  ...
  var displayValues = React.useMemo(
    function () {
      ...
      var displayKeys = (0, _strategyUtil.formatStrategyValues)(
        rawCheckedValues,
      ...
      var values = displayKeys.map(function (key) {
        ...
        return (_keyEntities$key$node =
          (_keyEntities$key = keyEntities[key]) === null ||
          _keyEntities$key === void 0 ||
          (_keyEntities$key = _keyEntities$key.node) === null ||
          _keyEntities$key === void 0
            ? void 0
            : _keyEntities$key[mergedFieldNames.value]) !== null &&
          _keyEntities$key$node !== void 0
      ...
      var labeledValues = values.map(function (val) {
        ...
        var label = labelInValue
          ? targetItem === null || targetItem === void 0
            ? void 0
            : targetItem.label
          : treeTitleRender === null || treeTitleRender === void 0
            ? void 0
            : treeTitleRender(targetItem);
        return {
          value: val,
          label: label,
        };
      ...
      if (
        !mergedMultiple &&
        firstVal &&
        (0, _valueUtil.isNil)(firstVal.value) &&
        (0, _valueUtil.isNil)(firstVal.label)
      ) {
        return [];
      }
  ...
  // ========================== MaxCount ==========================
  var mergedMaxCount = React.useMemo(
    function () {
      if (
        mergedMultiple &&
        (mergedShowCheckedStrategy === "SHOW_CHILD" ||
          treeCheckStrictly ||
          !treeCheckable)
      ) {
        return maxCount;
  ...
  // =========================== Change ===========================
  var triggerChange = (0, _useRefFunc.default)(
    function (newRawValues, extra, source) {
      var formattedKeyList = (0, _strategyUtil.formatStrategyValues)(
        newRawValues,
        mergedShowCheckedStrategy,
        keyEntities,
        mergedFieldNames,
      ...
      if (onChange) {
        ...
        if (treeCheckStrictly) {
          ...
          returnRawValues = [].concat(
            (0, _toConsumableArray2.default)(returnRawValues),
            (0, _toConsumableArray2.default)(halfValues),
          );
        }
        ...
        (0, _legacyUtil.fillAdditionalInfo)(
          additionalInfo,
          triggerValue,
          newRawValues,
          mergedTreeData,
  ...
  var onOptionSelect = React.useCallback(
    function (selectedKey, _ref2) {
      ...
      var selectedValue =
        (_node$mergedFieldName =
          node === null || node === void 0
            ? void 0
            : node[mergedFieldNames.value]) !== null &&
      ...
      if (!mergedMultiple) {
        ...
        var newRawValues = selected
          ? [].concat((0, _toConsumableArray2.default)(rawValues), [
              selectedValue,
            ])
        ...
        if (treeConduction) {
          ...
          // Fill back of keys
          newRawValues = [].concat(
            (0, _toConsumableArray2.default)(missingRawValues),
  ...
  // ========================== Dropdown ==========================
  var onInternalDropdownVisibleChange = React.useCallback(
    function (open) {
  ...
  // ====================== Display Change ========================
  var onDisplayValuesChange = (0, _useRefFunc.default)(
    function (newValues, info) {
  ...
  // ========================== Context ===========================
  var treeSelectContext = React.useMemo(
    function () {
      return {
        virtual: virtual,
        ...
        leftMaxCount:
          maxCount === undefined ? null : maxCount - cachedDisplayValues.length,
        leafCountOnly:
          mergedShowCheckedStrategy === "SHOW_CHILD" &&
          !treeCheckStrictly &&
          !!treeCheckable,
  ...
  // ======================= Legacy Context =======================
  var legacyContext = React.useMemo(
    function () {
      return {
  ...
  return /*#__PURE__*/ React.createElement(
    _TreeSelectContext.default.Provider,
    {
      value: treeSelectContext,
    },
    /*#__PURE__*/ React.createElement(
      _LegacyContext.default.Provider,
      {
        value: legacyContext,
      },
      /*#__PURE__*/ React.createElement(
