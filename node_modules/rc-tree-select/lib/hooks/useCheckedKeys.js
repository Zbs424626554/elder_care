...
var useCheckedKeys = function useCheckedKeys(
  rawLabeledValues,
  ...
  return React.useMemo(
    function () {
      ...
      if (treeConduction) {
        var conductResult = (0, _conductUtil.conductCheck)(
          checkedKeys,
          true,
          keyEntities,
        );
      ...
      return [
        Array.from(
          new Set(
            [].concat(
              (0, _toConsumableArray2.default)(missingValues),
              (0, _toConsumableArray2.default)(finalCheckedKeys),
            ),
          ),
        ),
