...
var useFilterTreeData = function useFilterTreeData(
  treeData,
  searchValue,
  options,
) {
    ...
    function () {
      ...
      var filterOptionFunc =
        typeof filterTreeNode === "function"
          ? filterTreeNode
          : function (_, dataNode) {
              return String(dataNode[treeNodeFilterProp])
                .toUpperCase()
