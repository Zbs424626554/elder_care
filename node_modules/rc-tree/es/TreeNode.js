...
var TreeNode = function TreeNode(props) {
  ...
  var isSelectable = React.useMemo(
    function () {
  ...
  // ======= State: Leaf Check =======
  var memoizedIsLeaf = React.useMemo(
    function () {
      if (isLeaf === false) {
        return false;
      }
  ...
  // ====================== Checkbox ======================
  var checkboxNode = React.useMemo(
    function () {
      if (!isCheckable) {
        return null;
      }
  ...
  // =================== Drop Indicator ===================
  var dropIndicatorNode = React.useMemo(
    function () {
  ...
  // Icon + Title
  var selectorNode = React.useMemo(
    function () {
