...
export declare function fillFieldNames(
  fieldNames?: FieldNames,
): Required<FieldNames>;
/**
 * Warning if TreeNode do not provides key
 */
export declare function warningWithoutKey(
  treeData: DataNode[],
  fieldNames: FieldNames,
): void;
/**
 ...
 */
export declare function convertTreeToData(
  rootNodes: React.ReactNode,
): DataNode[];
/**
 ...
 */
export declare function flattenTreeData<
 ...
 */
export declare function traverseDataNodes(
  dataNodes: DataNode[],
  callback: (data: {
    node: DataNode;
    index: number;
 ...
 */
export declare function getTreeNodeProps<
  TreeDataType extends BasicDataNode = DataNode,
>(
  key: Key,
  {
...
export declare function convertNodePropsToEventData<
  TreeDataType extends BasicDataNode = DataNode,
