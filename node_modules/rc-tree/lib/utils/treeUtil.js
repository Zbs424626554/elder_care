  ...
  function dig(list) {
    ...
    return list.map(function (treeNode, index) {
      ...
      var flattenNode = Object.assign(
        (0, _omit.default)(
          treeNode,
          [].concat((0, _toConsumableArray2.default)(fieldTitles), [
            fieldKey,
            fieldChildren,
          ]),
        ),
        {
          ...
          data: treeNode,
          isStart: [].concat(
            (0, _toConsumableArray2.default)(parent ? parent.isStart : []),
            [index === 0],
          ),
          isEnd: [].concat(
            (0, _toConsumableArray2.default)(parent ? parent.isEnd : []),
            [index === list.length - 1],
          ),
        },
      );
...
function traverseDataNodes(
  ...
  function processNode(node, index, parent, pathNodes) {
    ...
    var connectNodes = node
      ? [].concat((0, _toConsumableArray2.default)(pathNodes), [node])
      : [];
...
function convertNodePropsToEventData(props) {
  ...
  var eventData = (0, _objectSpread2.default)(
