  ...
  function Tree() {
    ...
    (0, _defineProperty2.default)(
      ...
      function (event, nodeProps) {
        ...
        _this.setState({
          ...
          dragChildrenKeys: (0, _util.getDragChildrenKeys)(
            eventKey,
            keyEntities,
          ),
    ...
    (0, _defineProperty2.default)(
      ...
      function (event, nodeProps) {
        ...
        var _calcDropPosition = (0, _util.calcDropPosition)(
            event,
            _this.dragNodeProps,
            nodeProps,
            indent,
        ...
        if (_this.dragNodeProps.eventKey !== nodeProps.eventKey) {
          ...
          _this.delayedDragEnterLogic[pos] = window.setTimeout(function () {
            ...
            var newExpandedKeys = (0, _toConsumableArray2.default)(
              expandedKeys,
            );
            var entity = (0, _keyUtil.default)(keyEntities, nodeProps.eventKey);
            if (entity && (entity.children || []).length) {
              newExpandedKeys = (0, _util.arrAdd)(
                expandedKeys,
                nodeProps.eventKey,
              );
            }
    ...
    (0, _defineProperty2.default)(
      ...
      function (event, nodeProps) {
        ...
        var _calcDropPosition2 = (0, _util.calcDropPosition)(
            event,
            _this.dragNodeProps,
            nodeProps,
            indent,
    ...
    (0, _defineProperty2.default)(
      ...
      function (event, _) {
        ...
        var abstractDropNodeProps = (0, _objectSpread3.default)(
          (0, _objectSpread3.default)(
            {},
            (0, _treeUtil.getTreeNodeProps)(
              dropTargetKey,
          ...
          {},
          {
            ...
            data: (0, _keyUtil.default)(_this.state.keyEntities, dropTargetKey)
              .node,
          },
        );
        ...
        var dropResult = {
          event: event,
          node: (0, _treeUtil.convertNodePropsToEventData)(
            abstractDropNodeProps,
          ),
          dragNode: _this.dragNodeProps
            ? (0, _treeUtil.convertNodePropsToEventData)(_this.dragNodeProps)
            : null,
    ...
    (0, _defineProperty2.default)(
      ...
      function (e, treeNode) {
        ...
        var eventNode = (0, _treeUtil.convertNodePropsToEventData)(
          (0, _objectSpread3.default)(
            (0, _objectSpread3.default)(
              {},
              (0, _treeUtil.getTreeNodeProps)(
        ...
        _this.setExpandedKeys(
          expanded
            ? (0, _util.arrDel)(expandedKeys, key)
            : (0, _util.arrAdd)(expandedKeys, key),
        );
      ...
      function (e, treeNode, checked) {
        ...
        if (checkStrictly) {
          var checkedKeys = checked
            ? (0, _util.arrAdd)(oriCheckedKeys, key)
            : (0, _util.arrDel)(oriCheckedKeys, key);
          ...
          var _conductCheck = (0, _conductUtil.conductCheck)(
              [].concat((0, _toConsumableArray2.default)(oriCheckedKeys), [
                key,
              ]),
              true,
              keyEntities,
    ...
    (0, _defineProperty2.default)(
      ...
      function (expandedKeys) {
        ...
        var flattenNodes = (0, _treeUtil.flattenTreeData)(
          treeData,
          expandedKeys,
          fieldNames,
        );
          ...
          if (loadPromise) {
            loadPromise
              .then(function () {
                ...
                var newFlattenTreeData = (0, _treeUtil.flattenTreeData)(
              ...
              .catch(function () {
                ...
                var expandedKeysToRestore = (0, _util.arrDel)(
                  currentExpandedKeys,
                  key,
                );
      ...
      function (state) {
        ...
        if (!_this.destroyed) {
          ...
          if (needSync && (!atomic || allPassed)) {
            _this.setState(
              (0, _objectSpread3.default)(
                (0, _objectSpread3.default)({}, newState),
                forceState,
              ),
            );
          }
      ...
      },
      {
        ...
        value: function render() {
          ...
          return /*#__PURE__*/ React.createElement(
            _contextTypes.TreeContext.Provider,
            {
              value: contextValue,
            },
    ...
    [
      {
        ...
        value: function getDerivedStateFromProps(props, prevState) {
          ...
          if (treeData) {
            ...
            newState.keyEntities = (0, _objectSpread3.default)(
              (0, _defineProperty2.default)(
                {},
                _NodeList.MOTION_KEY,
                _NodeList.MotionEntity,
              ),
          ...
          if (props.selectable) {
            if (needSync("selectedKeys")) {
              newState.selectedKeys = (0, _util.calcSelectedKeys)(
                props.selectedKeys,
                props,
              );
          ...
          if (props.checkable) {
            ...
            if (needSync("checkedKeys")) {
              checkedKeyEntity =
                (0, _util.parseCheckedKeys)(props.checkedKeys) || {};
            } else if (!prevProps && props.defaultCheckedKeys) {
              checkedKeyEntity =
                (0, _util.parseCheckedKeys)(props.defaultCheckedKeys) || {};
            } else if (treeData) {
              // If `treeData` changed, we also need check it
              checkedKeyEntity = (0, _util.parseCheckedKeys)(
                props.checkedKeys,
              ) || {
            ...
            if (checkedKeyEntity) {
              ...
              if (!props.checkStrictly) {
                var conductKeys = (0, _conductUtil.conductCheck)(
                  checkedKeys,
                  true,
                  keyEntities,
                );
