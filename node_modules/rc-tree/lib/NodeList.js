...
var NodeList = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  (0, _useLayoutEffect.default)(
    function () {
      ...
      var diffExpanded = (0, _diffUtil.findExpandedKeys)(
        prevExpandedKeys,
        expandedKeys,
      );
      if (diffExpanded.key !== null) {
        if (diffExpanded.add) {
          ...
          var rangeNodes = getMinimumRangeTransitionRange(
            (0, _diffUtil.getExpandRange)(prevData, data, diffExpanded.key),
            virtual,
            height,
            itemHeight,
          );
          ...
          var _rangeNodes = getMinimumRangeTransitionRange(
            (0, _diffUtil.getExpandRange)(data, prevData, diffExpanded.key),
            virtual,
            height,
            itemHeight,
          );
      ...
      function (treeNode) {
        var pos = treeNode.pos,
          restProps = Object.assign(
            {},
            ((0, _objectDestructuringEmpty2.default)(treeNode.data),
            treeNode.data),
          ),
        ...
        var treeNodeProps = (0, _treeUtil.getTreeNodeProps)(
          mergedKey,
          treeNodeRequiredProps,
        );
        return /*#__PURE__*/ React.createElement(
          _MotionTreeNode.default,
          (0, _extends2.default)({}, restProps, treeNodeProps, {
            title: title,
