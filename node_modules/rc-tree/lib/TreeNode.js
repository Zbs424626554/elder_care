...
var TreeNode = function TreeNode(props) {
  ...
  var unstableContext = _react.default.useContext(
    _contextTypes.UnstableContext,
  );
  ...
  var isDisabled = !!(
    context.disabled ||
    props.disabled ||
    ((_unstableContext$node = unstableContext.nodeDisabled) !== null &&
      _unstableContext$node !== void 0 &&
      _unstableContext$node.call(unstableContext, data))
  );
  var isCheckable = _react.default.useMemo(
    function () {
  ...
  var onCheck = function onCheck(e) {
    ...
    context.onNodeCheck(
      e,
      (0, _treeUtil.convertNodePropsToEventData)(props),
      !checked,
    );
  };

  // ======= State: Selectable Check =======
  var isSelectable = _react.default.useMemo(
    function () {
  ...
  // ======= Drag: Drag Enabled =======
  var isDraggable = _react.default.useMemo(
    function () {
      return !!(
        context.draggable &&
  ...
  // ======= State: Has Children =======
  var hasChildren = _react.default.useMemo(
    function () {
  ...
  // ======= State: Leaf Check =======
  var memoizedIsLeaf = _react.default.useMemo(
    function () {
      if (isLeaf === false) {
        return false;
      }
  ...
  // ==================== Render: Drag Handler ====================
  var dragHandlerNode = _react.default.useMemo(
    function () {
      var _context$draggable;
      if (
        !(
          (_context$draggable = context.draggable) !== null &&
          _context$draggable !== void 0 &&
  ...
  // ====================== Checkbox ======================
  var checkboxNode = _react.default.useMemo(
    function () {
      if (!isCheckable) {
        return null;
      }
      ...
      return /*#__PURE__*/ _react.default.createElement(
        "span",
        {
          className: (0, _classnames.default)(
            ...
            (0, _defineProperty2.default)(
              (0, _defineProperty2.default)(
                ...
                "".concat(context.prefixCls, "-checkbox-indeterminate"),
                !checked && halfChecked,
              ),
          ...
          "aria-label": "Select ".concat(
            typeof props.title === "string" ? props.title : "tree node",
          ),
        },
        $custom,
      );
  ...
  var nodeState = _react.default.useMemo(
    function () {
      if (memoizedIsLeaf) {
        return null;
      }
  ...
  // ==================== Render: Title + Icon ====================
  var iconNode = _react.default.useMemo(
    function () {
      return /*#__PURE__*/ _react.default.createElement("span", {
        className: (0, _classnames.default)(
          "".concat(context.prefixCls, "-iconEle"),
          "".concat(context.prefixCls, "-icon__").concat(nodeState || "docu"),
          (0, _defineProperty2.default)(
            {},
  ...
  // =================== Drop Indicator ===================
  var dropIndicatorNode = _react.default.useMemo(
    function () {
  ...
  // Icon + Title
  var selectorNode = _react.default.useMemo(
    function () {
  ...
  return /*#__PURE__*/ _react.default.createElement(
        ...
        className: (0, _classnames.default)(
                ...
                (0, _defineProperty2.default)(
                  (0, _defineProperty2.default)(
                    (0, _defineProperty2.default)(
                      (0, _defineProperty2.default)(
                        (0, _defineProperty2.default)(
                          (0, _defineProperty2.default)(
                            ...
                            ""
                              .concat(context.prefixCls, "-treenode-switcher-")
                      ...
                      "".concat(context.prefixCls, "-treenode-selected"),
                      selected,
                    ),
          ...
          (0, _defineProperty2.default)(
            (0, _defineProperty2.default)(
              ...
              "filter-node",
              (_context$filterTreeNo = context.filterTreeNode) === null ||
                _context$filterTreeNo === void 0
                ? void 0
    ...
    /*#__PURE__*/ _react.default.createElement(_Indent.default, {
      prefixCls: context.prefixCls,
      level: level,
      isStart: isStart,
      isEnd: isEnd,
