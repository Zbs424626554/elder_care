...
var Panel = /*#__PURE__*/ _react.default.forwardRef(function (props, ref) {
  ...
  var headerNode = title
    ...
    : null;
  var closableObj = (0, _react.useMemo)(
    function () {
  ...
  var closeBtnIsDisabled =
    (0, _typeof2.default)(closable) === "object" && closable.disabled;
      ...
      (0, _extends2.default)(
        {
          ...
          style: (0, _objectSpread2.default)(
            (0, _objectSpread2.default)({}, bodyStyle),
            modalStyles === null || modalStyles === void 0
              ? void 0
              : modalStyles.body,
          ),
