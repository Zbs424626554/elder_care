...
import { UserOutline, SetOutline, CloseOutline, RightOutline } from 'antd-mobile-icons';
    ...
    <div className={styles.profile}>
        ...
        <div className={styles.profileInfo}>
          ...
          <div className={styles.profileDetails}>
            ...
            <div className={styles.profileMembership}>
              ...
              <span className={styles.profilePoints}>积分: {userInfo.points}</span>
            </div>
          </div>
          <Button
      ...
      <Card className={styles.settingsCard}>
        <div className={styles.settingsList}>
          <div className={styles.settingItem} onClick={() => console.log('关于我们')}>
          ...
          <div className={styles.settingItem} onClick={() => console.log('隐私政策')}>
            <div className={styles.settingContent}>
          ...
          <div className={styles.settingItem} onClick={() => console.log('用户协议')}>
            <div className={styles.settingContent}>
