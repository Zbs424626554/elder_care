...
var _miniDecimal = _interopRequireWildcard(
...
var InternalInputNumber = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  var prefixCls = props.prefixCls,
    ...
    changeOnWheel =
      _props$changeOnWheel === void 0 ? false : _props$changeOnWheel,
  ...
  var getPrecision = React.useCallback(
    function (numStr, userTyping) {
      ...
      return Math.max(
        (0, _miniDecimal.getNumberPrecision)(numStr),
        (0, _miniDecimal.getNumberPrecision)(step),
      );
    },
    [precision, step],
  );
  ...
  // >>> Parser
  var mergedParser = React.useCallback(
    function (num) {
  ...
  var mergedFormatter = React.useCallback(
    function (number, userTyping) {
      ...
      var str =
        typeof number === "number" ? (0, _miniDecimal.num2str)(number) : number;

      // User typing will not auto format with precision directly
      if (!userTyping) {
        var mergedPrecision = getPrecision(str, userTyping);
        if (
          (0, _miniDecimal.validateNumber)(str) &&
  ...
  var _React$useState5 = React.useState(function () {
      ...
      if (
        ...
        ["string", "number"].includes((0, _typeof2.default)(initValue))
      ) {
  ...
  var minDecimal = React.useMemo(
    function () {
      return getDecimalIfValidate(min);
    },
    [min, precision],
  );
  var upDisabled = React.useMemo(
    function () {
  ...
  var downDisabled = React.useMemo(
    function () {
  ...
  var triggerValueUpdate = function triggerValueUpdate(newValue, userTyping) {
    ...
    if (!readOnly && !disabled && isRangeValidate) {
      ...
      if (mergedPrecision >= 0) {
        updateValue = (0, _miniDecimal.default)(
          (0, _miniDecimal.toFixed)(numStr, ".", mergedPrecision),
        );
        ...
        if (!isInRange(updateValue)) {
          updateValue = (0, _miniDecimal.default)(
            (0, _miniDecimal.toFixed)(numStr, ".", mergedPrecision, true),
          );
        }
      }
  ...
  var onInternalStep = function onInternalStep(up) {
    ...
    var stepDecimal = (0, _miniDecimal.default)(
      shiftKeyRef.current ? (0, _numberUtil.getDecupleSteps)(step) : step,
    );
    if (!up) {
      stepDecimal = stepDecimal.negate();
    }
    var target = (decimalValue || (0, _miniDecimal.default)(0)).add(
    ...
    onStep === null ||
      ...
      onStep(getDecimalValue(stringMode, updatedValue), {
        offset: shiftKeyRef.current
          ? (0, _numberUtil.getDecupleSteps)(step)
          : step,
        type: up ? "up" : "down",
      });
  ...
  (0, _useLayoutEffect.useLayoutUpdateEffect)(
    function () {
      ...
      var currentParsedValue = (0, _miniDecimal.default)(
...
var InputNumber = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  var disabled = props.disabled,
    ...
    prefixCls =
      _props$prefixCls === void 0 ? "rc-input-number" : _props$prefixCls,
    value = props.value,
    prefix = props.prefix,
    suffix = props.suffix,
