...
var AsyncValidationError = (exports.AsyncValidationError =
    ...
    for (var s in source) {
      if (source.hasOwnProperty(s)) {
        ...
        if (
          ...
          (0, _typeof2.default)(target[s]) === "object"
        ) {
          target[s] = (0, _objectSpread2.default)(
            (0, _objectSpread2.default)({}, target[s]),
            value,
          );
        } else {
          target[s] = value;
