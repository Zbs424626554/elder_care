  ...
  (0, _createClass2.default)(Schema, [
    ...
    },
    {
      ...
      value: function messages(_messages) {
        if (_messages) {
          this._messages = (0, _util.deepMerge)(
            (0, _messages2.newMessages)(),
            _messages,
          );
        }
          ...
          function add(e) {
            if (Array.isArray(e)) {
              ...
              errors = (_errors = errors).concat.apply(
                _errors,
                (0, _toConsumableArray2.default)(e),
              );
            } else {
              errors.push(e);
            }
        ...
        return (0, _util.asyncMap)(
          ...
          function (data, doIt) {
            ...
            var deep =
              ...
              ((0, _typeof2.default)(rule.fields) === "object" ||
                (0, _typeof2.default)(rule.defaultField) === "object");
            deep = deep && (rule.required || (!rule.required && data.value));
            rule.field = data.field;
            function addFullField(key, schema) {
              return (0, _objectSpread2.default)(
                (0, _objectSpread2.default)({}, schema),
                {},
                {
                  fullField: "".concat(rule.fullField, ".").concat(key),
                  fullFields: rule.fullFields
                    ? [].concat(
                        (0, _toConsumableArray2.default)(rule.fullFields),
                        [key],
                      )
                    : [key],
                },
            ...
            function cb() {
              ...
              var filledErrors = errorList.map(
                (0, _util.complementError)(rule, source),
              );
              ...
              if (!deep) {
                ...
                if (rule.required && !data.value) {
                  if (rule.message !== undefined) {
                    filledErrors = []
                      .concat(rule.message)
                      .map((0, _util.complementError)(rule, source));
                ...
                fieldsSchema = (0, _objectSpread2.default)(
                  (0, _objectSpread2.default)({}, fieldsSchema),
                  data.rule.fields,
                );
                  ...
                  function (errs) {
                    ...
                    if (filledErrors && filledErrors.length) {
                      finalErrors.push.apply(
                        finalErrors,
                        (0, _toConsumableArray2.default)(filledErrors),
                      );
                    }
                    if (errs && errs.length) {
                      finalErrors.push.apply(
                        finalErrors,
                        (0, _toConsumableArray2.default)(errs),
                      );
                    }
    ...
    },
    {
      ...
      value: function getType(rule) {
        ...
        if (
          ...
          rule.type &&
          !_index.default.hasOwnProperty(rule.type)
        ) {
