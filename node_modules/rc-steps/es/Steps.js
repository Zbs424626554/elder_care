...
function Steps(props) {
  ...
  var _props$prefixCls = props.prefixCls,
    ...
    labelPlacement =
      _props$labelPlacement === void 0 ? "horizontal" : _props$labelPlacement,
  ...
  var classString = classNames(
    ...
    _defineProperty(_classNames, "".concat(prefixCls, "-navigation"), isNav),
    _defineProperty(_classNames, "".concat(prefixCls, "-inline"), isInline),
    _classNames),
  );
