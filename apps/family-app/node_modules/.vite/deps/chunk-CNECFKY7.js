...
function useStatus(supportMotion, visible, getElement, _ref) {
  ...
  var eventHandlers = React12.useMemo(
    function() {
  ...
  var _useStepQueue = useStepQueue_default(
    ...
    function(newStep) {
      ...
      if (step in eventHandlers) {
        ...
        setStyle(
          ((_eventHandlers$step = eventHandlers[step]) === null || _eventHandlers$step === void 0 ? void 0 : _eventHandlers$step.call(
            eventHandlers,
            getDomElement(),
            null
          )) || null
...
function genCSSMotion(config) {
  ...
  var CSSMotion = React13.forwardRef(function(props, ref) {
    ...
    var setNodeRef = React13.useCallback(
      function(node) {
    ...
    function CSSMotionList2() {
      ...
      _defineProperty(
        ...
        function(removeKey) {
          _this.setState(
            function(prevState) {
              var nextKeyEntities = prevState.keyEntities.map(
                function(entity) {
      ...
      [
        {
          ...
          value: function render() {
            ...
            var Component3 = component || React14.Fragment;
            var motionProps = {};
...
*/
//# sourceMappingURL=chunk-CNECFKY7.js.map
